...
open class TestKotlinSpringBootApplication : SpringBootServletInitializer() {
    ...
    override fun configure(application: SpringApplicationBuilder): SpringApplicationBuilder =
            application.sources(TestKotlinSpringBootApplication::class.java)
    ...
    companion object {
        ...
        @JvmStatic fun main(args: Array<String>) {
            ...
            SpringApplication.run(TestKotlinSpringBootApplication::class.java, *args)
        }
    }
}
